         ...
         <div class="section about_section layout_padding padding_top_0">
            <div class="container">
               <div class="row">
                  ...
                  <div class="col-lg-10 offset-lg-1">
                     <div class="full text_align_center">
                         ...
                         text-justify: inter-word;">Nuestro objetivo es evidenciar, por medio de las TICS, un apoyo virtual conjunto y colaborativo, a los empresarios, comerciantes y emprendedores, haciéndoles partícipes de las herramientas tecnológicos que se encuentran disponibles para afrontar la situación del país y del mundo.</p>
                     </div>
                  </div>
               </div>
               <br>
               <div class="row">
                  <div class="col-md-12">
                     <div class="full text_align_center">
                       <img class="img-responsive" style="border-radius: 40px; width: 700px; height: 400px;" src="images/customer-563967_1920.jpg" alt="#" />
                     </div>
