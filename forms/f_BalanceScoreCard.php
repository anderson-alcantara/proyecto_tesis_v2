...
<div id="pag1">
  <!--Titulo princiapl-->
  <div style="">
<div class="form__title" style="font-weight:bold; font-size:25px"><a id="nombre_form">FORMATO BALANCE SCORE CARD</a></div>
<p style="color: red;">FOR-AC-008</p>
</div>
...
<h5>BALANCE SCORE CARD (VISIÓN Y ESTRATEGIA)</h5>
<h6>
Para alcanzar los objetivos y tener éxitos en los pilares del cuadro de mando integral, cómo deberían verlo los inversionistas (financiero) y los clientes (cliente); En qué procesos debe sobresalir (Procesos Internos del Negocio); y como puede mantener la habilidad de cambiar y progresar (Aprendizaje y Crecimiento ).
</h6>
<hr>

<div class="form-row">
<div class="form-group col-md-6">
      <label for="inputEmail4" class="required">FINANCIERO</label>
      <textarea class="form-control" id="inputEmail4" rows="3" style="white-space: pre-wrap;" required></textarea>
    </div>
    <div class="form-group col-md-6">
      <label for="inputEmail4" class="">CLIENTE</label>
...
<div class="form-row">
<div class="form-group col-md-6">
      <label for="inputEmail4" class="required">PROCESOS INTERNOS DEL NEGOCIO</label>
      <textarea class="form-control" id="inputEmail4" rows="3" style="white-space: pre-wrap;" required></textarea>
    </div>
    <div class="form-group col-md-6">
      <label for="inputEmail4" class="">APRENDIZAJE Y CRECIMIENTO</label>
      <textarea class="form-control" id="inputEmail4" rows="3" style="white-space: pre-wrap;" ></textarea>
    </div>
  </div>
