...
<div class="login-page">
            <div class="form">
			<div class="form__title"><a style=" font-size:30px;" id="nombre_form">Formato De Perfilación De Puestos De Trabajo</a>
<p style="color: white; font-size:18px;">FOR-AC-006</p>
</div>
			<div class="form__item">
<label for="exampleInputEmail1">Email address</label>
<input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" style="width:50%;" placeholder="Enter email">
  <br>
</div>
<hr>
