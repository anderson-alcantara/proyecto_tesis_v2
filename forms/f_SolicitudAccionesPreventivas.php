...
<hr>
  ...
  <div class="form-row">
  <div class="form-group col-md-6">
      <label for="inputEmail4" class="required">TIPO DE ACCIÓN</label>
      <input type="text" class="form-control" id="inputEmail4" placeholder="" required>
    </div>
    <div class="form-group col-md-6">
      <label for="inputEmail4" class="required">No. ACCIÓN</label>
      <input type="text" class="form-control" id="inputEmail4" placeholder="" required>
    </div>
...
<div class="form-group col-md-6">
    <label for="inputEmail4" class="required">ÁREA DONDE SE DETECTA LA NO CONFORMIDAD O POTENCIAL PROBLEMA </label>
    <input type="text" class="form-control" id="inputEmail4" placeholder="" required>
  </div>
  <div class="form-group col-md-6">
...
<div class="form-group col-md-6">
  ...
  <div class="form-group col-md-6">
    <label for="inputEmail4" class="required">FECHA DE DETECCIÓN </label>
...
<div class="form-row">
<div class="form-group col-md-6">
    <label for="exampleFormControlSelect1" class="required">1. Descripción de la no conformidad o del Potencial problema: </label>
...
<div class="form-group col-md-6">
  ...
  <div class="form-group col-md-6">
    <label for="exampleFormControlSelect1" class="required">2. Análisis de la causa</label>
    <textarea class="form-control" id="inputEmail4" rows="3" style="white-space: pre-wrap;" required></textarea>
    </div>
...
<div class="form-row">
<div class="form-group col-md-6">
    <label for="exampleFormControlSelect1" class="required">3. Metodología utilizada para detectarla</label>
    <textarea class="form-control" id="inputEmail4" rows="3" style="white-space: pre-wrap;" required></textarea>
    </div>
    <div class="form-group col-md-6">
...
<div class="form-row">
<div class="form-group col-md-6">
    <label for="exampleFormControlSelect1" class="required">4. Plan de acción: Actividades </label>
    <textarea class="form-control" id="inputEmail4" rows="3" style="white-space: pre-wrap;" required></textarea>
    </div>
    <div class="form-group col-md-6">
    <label for="exampleFormControlSelect1" class="required">ACCIONES CORRECTIVAS (Descripción detallada) </label>
    <textarea class="form-control" id="inputEmail4" rows="3" style="white-space: pre-wrap;" required></textarea>
    </div>
...
<div class="form-group col-md-6">
    ...
    <div class="form-group col-md-6">
      <label for="exampleFormControlSelect1" class="">¿SE LE DIÓ CIERRE?</label>
...
<div class="form-group col-md-6">
    ...
    <div class="form-group col-md-6">
    <label for="exampleFormControlSelect1" class="required">Verificación, Validación y seguimiento de la acción tomada: Actividades y Estado de la misma</label>
    <textarea class="form-control" id="inputEmail4" rows="3" style="white-space: pre-wrap;" required></textarea>
    </div>
...
<div class="form-row">
<div class="form-group col-md-6">
      <label for="inputEmail4" class="">EVIDENCIA CIERRE DE LA ACCIÓN</label>
