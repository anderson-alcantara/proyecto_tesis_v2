...
<div class="form-group col-md-6">
    ...
    <div class="form-group col-md-6">
      <label for="inputEmail4" class="required">FECHA DE INICIO DE LA ASESORÍA</label>
...
<div class="form-row">
<div class="form-group col-md-6">
      <label for="inputEmail4" class="required">FECHA FIN DE LA ASESORÍA</label>
      <input type="date" class="form-control" id="inputEmail4" placeholder="" required>
    </div>
    <div class="form-group col-md-6">
...
<div class="form-row">
    ...
    <div class="form-group col-md-6">
      <label for="inputEmail4">PROBLEMAS DE ASESORÍA (B)</label>
      <input type="text" class="form-control" id="inputEmail4" placeholder="" >
    </div>
