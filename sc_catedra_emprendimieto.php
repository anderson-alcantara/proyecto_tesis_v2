               ...
               <div class="row">
                  <div class="col-md-12">
                     <div class="full">
                        <div class="heading_main text_align_center margin-bottom_30">
                           <h2><br>Cátedra de emprendimiento</h2>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-10 offset-lg-1">
                     <div class="full text_align_center">
                         ...
                         text-justify: inter-word;">Es un espacio multidisciplinar que busca el desarrollo
de habilidades y competencias que permitan a los
estudiantes crear y ejecutar ideas de negocio viables o
intraemprendimientos que le aporten a su proyecto de
vida.</p>
                     </div>
                  </div>
               </div>
               ...
               <div class="row">
                  <div class="col-md-12">
                     <div class="full text_align_center">
                       <img class="img-responsive" style="border-radius: 40px; width: 900px; height: 500px;" src="images/office-1574717_1920.jpg" alt="#" />
                     </div>
