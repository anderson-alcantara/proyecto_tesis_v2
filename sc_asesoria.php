               ...
               <div class="row">
                  ...
                  <div class="col-lg-10 offset-lg-1">
                     <div class="full text_align_center">
                         ...
                         <ul style="font-size: 20px; font-weight: normal; text-align: left;">
                             <li>*Coaching Empresarial</li>
                             <li>*Habilidades Gerenciales</li>
                             <li>*Creación de Empresa</li>
                             <li>*Investigación de Mercados</li>
                             <li>*Comunicación Efectiva y Asertiva en las Organizaciones</li>
                             <li>*Planeación Estratégica para PYMES</li>
                             <li>*Gerencia del Talento Humano</li>
                             <li>*Economía de Empresa y Coyuntura Económica</li>
                         </ul>
                     </div>
                  </div>
               </div>
               ...
               <div class="row">
                  ...
                  <div class="col-lg-10 offset-lg-1">
                     <div class="full text_align_center">
                         ...
                         text-justify: inter-word;"></p>
                         <ul style="font-size: 20px; font-weight: normal; text-align: left;">
                             <li>*Orientación y Uso de Análisis de cuentas</li>
                             <li>*Elaboración de Estados Financieros </li>
                             <li>*Elaboración de Reportes Dirigidos a Entidades de Control</li>
                             <li>*Elaboración de Declaraciones tributarias</li>
                             <li>*Liquidación y Registro de Importaciones</li>
                             <li>*Conciliaciones bancarias</li>
                             <li>*Presentación e Interpretación de Informes</li>
                             <li>*Normas Internacionales de
Información Financiera (NllF)
</li>
                         </ul>
                     </div>
                  </div>
               ...
               <div class="row">
                  <div class="col-md-12">
                     <div class="full text_align_center">
                     <img class="img-responsive" style="border-radius: 40px; width: 900px; height: 500px;" src="images/calculator-385506_1920.jpg" alt="#" />
                     </div>
