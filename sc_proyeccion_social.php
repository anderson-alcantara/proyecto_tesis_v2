         ...
         <div class="section about_section layout_padding padding_top_0">
            <div class="container">
               <div class="row">
                  ...
                  <div class="col-lg-10 offset-lg-1">
                     <div class="full text_align_center">
                         ...
                         text-justify: inter-word;">Lograr la articulación Universidad-Comunidad en requerimientos de capacitación, asesoría, acompañamientos, diagnósticos y diseño de formulación y restructuración de proyectos .</p>
                     </div>
                  </div>
               </div>
               <br>
               <div class="row">
                  <div class="col-md-12">
                     <div class="full text_align_center">
                       <img class="img-responsive" style="border-radius: 40px; width: 700px; height: 500px;" src="images/entrepreneur-2326419_1920.jpg" alt="#" />
                     </div>
            ...
            <div class="container">
               <div class="row">
                  ...
                  <div class="col-lg-10 offset-lg-1">
                     <div class="full text_align_center">
                         <p style="text-align: justify; 
                         text-justify: inter-word;">Apoyar la comunidad ubicada en el área de influencia directa de la universidad en temas de capacitación, asesoría y acompañamiento </p>
                     </div>
                  </div>
               </div>
               <br>
